      ...
      <div className="container mx-auto px-4 max-w-4xl">
              ...
              <div className="p-5 hover:bg-gray-50 transition-colors duration-200">
                <div className="flex flex-col md:flex-row md:items-center justify-between">
                  ...
                  <div className="mt-4 md:mt-0">
                    <Link
                      to={`/jobs/${job.id}`}
                      className="inline-flex items-center justify-center bg-blue-100 hover:bg-blue-200 text-blue-600 font-medium py-2 px-4 rounded-md transition-colors duration-200"
                    >
        ...
        <div className="text-center mt-6">
          <Link
            ...
            className="inline-flex items-center text-blue-600 hover:text-purple-800 font-medium transition-colors duration-200"
          >
